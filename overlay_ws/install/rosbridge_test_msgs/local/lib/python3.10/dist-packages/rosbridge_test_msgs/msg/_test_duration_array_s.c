...
bool rosbridge_test_msgs__msg__test_duration_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbridge_test_msgs.msg._test_duration_array.TestDurationArray", full_classname_dest, 62) == 0);
  }
  rosbridge_test_msgs__msg__TestDurationArray * ros_message = _ros_message;
  {  // durations
    ...
    builtin_interfaces__msg__Duration * dest = ros_message->durations.data;
...
{
  /* NOTE(esteve): Call constructor of TestDurationArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbridge_test_msgs.msg._test_duration_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TestDurationArray");
  ...
  {  // durations
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->durations.data[i]);
