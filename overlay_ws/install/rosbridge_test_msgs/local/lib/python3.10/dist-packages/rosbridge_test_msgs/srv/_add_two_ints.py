...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rosbridge_test_msgs.srv.AddTwoInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from rosbridge_test_msgs.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from rosbridge_test_msgs.srv._add_two_ints import AddTwoInts_Request as Request
    from rosbridge_test_msgs.srv._add_two_ints import AddTwoInts_Response as Response
