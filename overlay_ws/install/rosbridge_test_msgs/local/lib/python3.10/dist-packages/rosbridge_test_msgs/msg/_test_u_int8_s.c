...
bool rosbridge_test_msgs__msg__test_u_int8__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbridge_test_msgs.msg._test_u_int8.TestUInt8", full_classname_dest, 46) == 0);
  }
  rosbridge_test_msgs__msg__TestUInt8 * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of TestUInt8 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbridge_test_msgs.msg._test_u_int8");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TestUInt8");
