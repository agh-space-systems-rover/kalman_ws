...
bool rosbridge_test_msgs__msg__test_char__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbridge_test_msgs.msg._test_char.TestChar", full_classname_dest, 43) == 0);
  }
  rosbridge_test_msgs__msg__TestChar * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of TestChar */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbridge_test_msgs.msg._test_char");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TestChar");
