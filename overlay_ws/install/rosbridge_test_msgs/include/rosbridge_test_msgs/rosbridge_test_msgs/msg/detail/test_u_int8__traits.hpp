...
inline std::string to_yaml(const TestUInt8 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rosbridge_test_msgs::msg::TestUInt8 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosbridge_test_msgs::msg::TestUInt8 & msg)
{
