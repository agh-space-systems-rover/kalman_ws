...
void fetch_function__TestFloat32Array__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__TestFloat32Array__data(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__TestFloat32Array__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__TestFloat32Array__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TestFloat32Array_message_member_array[1] = {
  {
    ...
    fetch_function__TestFloat32Array__data,  // fetch(index, &value) function pointer
    assign_function__TestFloat32Array__data,  // assign(index, value) function pointer
