...
rosbridge_test_msgs__msg__TestHeader__create()
{
  ...
  rosbridge_test_msgs__msg__TestHeader * msg = (rosbridge_test_msgs__msg__TestHeader *)allocator.allocate(sizeof(rosbridge_test_msgs__msg__TestHeader), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__msg__TestHeader__Sequence__init(rosbridge_test_msgs__msg__TestHeader__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__msg__TestHeader *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__msg__TestHeader), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__msg__TestHeader__Sequence * array = (rosbridge_test_msgs__msg__TestHeader__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__msg__TestHeader__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__msg__TestHeader__Sequence__are_equal(const rosbridge_test_msgs__msg__TestHeader__Sequence * lhs, const rosbridge_test_msgs__msg__TestHeader__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__msg__TestHeader__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__msg__TestHeader__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__msg__TestHeader);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__msg__TestHeader * data =
      (rosbridge_test_msgs__msg__TestHeader *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__msg__TestHeader__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__msg__TestHeader__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__msg__TestHeader__copy(
