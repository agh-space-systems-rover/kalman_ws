...
{
  new (message_memory) rosbridge_test_msgs::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosbridge_test_msgs::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[1] = {
  {
    ...
    offsetof(rosbridge_test_msgs::msg::Num, num),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  ...
  "Num",  // message name
  1,  // number of fields
  sizeof(rosbridge_test_msgs::msg::Num),
...
{
  return &::rosbridge_test_msgs::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbridge_test_msgs, msg, Num)() {
  return &::rosbridge_test_msgs::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
