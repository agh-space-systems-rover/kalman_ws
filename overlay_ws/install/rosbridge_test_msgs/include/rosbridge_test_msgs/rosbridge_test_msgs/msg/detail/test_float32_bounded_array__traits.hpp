...
inline void to_flow_style_yaml(
  const TestFloat32BoundedArray & msg,
  std::ostream & out)
{
  out << "{";
  // member: data
...
inline std::string to_yaml(const TestFloat32BoundedArray & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rosbridge_test_msgs::msg::TestFloat32BoundedArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosbridge_test_msgs::msg::TestFloat32BoundedArray & msg)
{
