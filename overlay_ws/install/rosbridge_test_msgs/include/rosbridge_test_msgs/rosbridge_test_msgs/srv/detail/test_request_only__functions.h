...
#ifndef ROSBRIDGE_TEST_MSGS__SRV__DETAIL__TEST_REQUEST_ONLY__FUNCTIONS_H_
#define ROSBRIDGE_TEST_MSGS__SRV__DETAIL__TEST_REQUEST_ONLY__FUNCTIONS_H_
...
/// Initialize srv/TestRequestOnly message.
/**
...
/// Finalize srv/TestRequestOnly message.
/**
...
/// Create srv/TestRequestOnly message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Request__init().
...
/// Destroy srv/TestRequestOnly message.
/**
 * It calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Request__fini()
...
/// Check for srv/TestRequestOnly message equality.
/**
...
/// Copy a srv/TestRequestOnly message.
/**
...
/// Initialize array of srv/TestRequestOnly messages.
/**
...
/// Finalize array of srv/TestRequestOnly messages.
/**
 * It calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Request__fini()
...
/// Create array of srv/TestRequestOnly messages.
/**
 * It allocates the memory for the array and calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TestRequestOnly messages.
/**
 * It calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/TestRequestOnly message array equality.
/**
...
/// Copy an array of srv/TestRequestOnly messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbridge_test_msgs
...
/**
 * It calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbridge_test_msgs
...
/**
 * It allocates the memory for the array and calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbridge_test_msgs
...
/**
 * It calls
 * rosbridge_test_msgs__srv__TestRequestOnly_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSBRIDGE_TEST_MSGS__SRV__DETAIL__TEST_REQUEST_ONLY__FUNCTIONS_H_
