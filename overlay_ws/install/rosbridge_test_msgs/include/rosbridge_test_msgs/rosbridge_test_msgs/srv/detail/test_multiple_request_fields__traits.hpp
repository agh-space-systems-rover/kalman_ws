...
inline void to_flow_style_yaml(
  const TestMultipleRequestFields_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: int_value
...
inline std::string to_yaml(const TestMultipleRequestFields_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rosbridge_test_msgs::srv::TestMultipleRequestFields_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosbridge_test_msgs::srv::TestMultipleRequestFields_Request & msg)
{
...
inline void to_flow_style_yaml(
  const TestMultipleRequestFields_Response & msg,
  std::ostream & out)
{
  (void)msg;
  out << "null";
...
inline std::string to_yaml(const TestMultipleRequestFields_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rosbridge_test_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbridge_test_msgs::srv::TestMultipleRequestFields_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbridge_test_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbridge_test_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbridge_test_msgs::srv::TestMultipleRequestFields_Response & msg)
{
  return rosbridge_test_msgs::srv::to_yaml(msg);
}
