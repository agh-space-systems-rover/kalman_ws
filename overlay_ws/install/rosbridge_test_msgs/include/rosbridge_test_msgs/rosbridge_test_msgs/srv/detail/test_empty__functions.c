  ...
  rosbridge_test_msgs__srv__TestEmpty_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rosbridge_test_msgs__srv__TestEmpty_Request * data =
      (rosbridge_test_msgs__srv__TestEmpty_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__srv__TestEmpty_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__srv__TestEmpty_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  rosbridge_test_msgs__srv__TestEmpty_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rosbridge_test_msgs__srv__TestEmpty_Response * data =
      (rosbridge_test_msgs__srv__TestEmpty_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__srv__TestEmpty_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__srv__TestEmpty_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
