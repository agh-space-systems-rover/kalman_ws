...
rosbridge_test_msgs__action__TestGoalOnly_Goal__create()
{
  ...
  rosbridge_test_msgs__action__TestGoalOnly_Goal * msg = (rosbridge_test_msgs__action__TestGoalOnly_Goal *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_Goal));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_Goal__init(msg);
  if (!success) {
...
rosbridge_test_msgs__action__TestGoalOnly_Goal__destroy(rosbridge_test_msgs__action__TestGoalOnly_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosbridge_test_msgs__action__TestGoalOnly_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Goal * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_Goal *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_Goal__fini(&data[i - 1]);
      }
...
rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence__init(array, size);
  if (!success) {
...
rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_Goal * data =
      (rosbridge_test_msgs__action__TestGoalOnly_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Result * msg = (rosbridge_test_msgs__action__TestGoalOnly_Result *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_Result));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_Result__destroy(rosbridge_test_msgs__action__TestGoalOnly_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosbridge_test_msgs__action__TestGoalOnly_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Result * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_Result *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_Result * data =
      (rosbridge_test_msgs__action__TestGoalOnly_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Feedback * msg = (rosbridge_test_msgs__action__TestGoalOnly_Feedback *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_Feedback));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_Feedback__destroy(rosbridge_test_msgs__action__TestGoalOnly_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosbridge_test_msgs__action__TestGoalOnly_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Feedback * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_Feedback *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_Feedback * data =
      (rosbridge_test_msgs__action__TestGoalOnly_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__init(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!rosbridge_test_msgs__action__TestGoalOnly_Goal__init(&msg->goal)) {
    rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__fini(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request * msg)
{
  ...
  // goal
  rosbridge_test_msgs__action__TestGoalOnly_Goal__fini(&msg->goal);
}
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request * lhs, const rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!rosbridge_test_msgs__action__TestGoalOnly_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request * msg = (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request * data =
      (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__init(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response * msg = (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response * data =
      (rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__init(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request * msg = (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request * data =
      (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__init(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!rosbridge_test_msgs__action__TestGoalOnly_Result__init(&msg->result)) {
    rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__fini(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response * msg)
{
  ...
  // status
  // result
  rosbridge_test_msgs__action__TestGoalOnly_Result__fini(&msg->result);
}
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response * lhs, const rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response * rhs)
{
  ...
  // result
  if (!rosbridge_test_msgs__action__TestGoalOnly_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response * msg = (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response * data =
      (rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__init(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!rosbridge_test_msgs__action__TestGoalOnly_Feedback__init(&msg->feedback)) {
    rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__fini(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  rosbridge_test_msgs__action__TestGoalOnly_Feedback__fini(&msg->feedback);
}
...
rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage * lhs, const rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!rosbridge_test_msgs__action__TestGoalOnly_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage * msg = (rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage));
  bool success = rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence__init(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence__fini(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence * array = (rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence__destroy(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage * data =
      (rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalOnly_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
