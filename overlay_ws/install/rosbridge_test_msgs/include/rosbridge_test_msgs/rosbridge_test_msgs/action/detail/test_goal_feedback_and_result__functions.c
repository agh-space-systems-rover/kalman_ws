...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__create()
{
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response * rhs)
{
  ...
  // result
  if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage * msg = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence__init(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence * array = (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence__are_equal(const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence * lhs, const rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage * data =
      (rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
