...
#ifndef ARUCO_OPENCV_MSGS__MSG__DETAIL__MARKER_POSE__FUNCTIONS_H_
#define ARUCO_OPENCV_MSGS__MSG__DETAIL__MARKER_POSE__FUNCTIONS_H_
 ...
 * calls
 * aruco_opencv_msgs__msg__MarkerPose__init().
...
/**
 * It calls
 * aruco_opencv_msgs__msg__MarkerPose__fini()
 ...
 * aruco_opencv_msgs__msg__MarkerPose__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * aruco_opencv_msgs__msg__MarkerPose__Sequence__fini()
 * on the array,
...
#endif  // ARUCO_OPENCV_MSGS__MSG__DETAIL__MARKER_POSE__FUNCTIONS_H_
