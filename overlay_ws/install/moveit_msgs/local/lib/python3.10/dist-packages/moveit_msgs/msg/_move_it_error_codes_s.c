...
bool moveit_msgs__msg__move_it_error_codes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._move_it_error_codes.MoveItErrorCodes", full_classname_dest, 53) == 0);
  }
  moveit_msgs__msg__MoveItErrorCodes * ros_message = _ros_message;
  {  // val
...
{
  /* NOTE(esteve): Call constructor of MoveItErrorCodes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_msgs.msg._move_it_error_codes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveItErrorCodes");
