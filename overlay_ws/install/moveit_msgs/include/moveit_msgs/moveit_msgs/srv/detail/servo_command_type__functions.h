...
#ifndef MOVEIT_MSGS__SRV__DETAIL__SERVO_COMMAND_TYPE__FUNCTIONS_H_
#define MOVEIT_MSGS__SRV__DETAIL__SERVO_COMMAND_TYPE__FUNCTIONS_H_
...
/// Initialize srv/ServoCommandType message.
/**
...
/// Finalize srv/ServoCommandType message.
/**
...
/// Create srv/ServoCommandType message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__ServoCommandType_Request__init().
...
/// Destroy srv/ServoCommandType message.
/**
 * It calls
 * moveit_msgs__srv__ServoCommandType_Request__fini()
...
/// Check for srv/ServoCommandType message equality.
/**
...
/// Copy a srv/ServoCommandType message.
/**
...
/// Initialize array of srv/ServoCommandType messages.
/**
...
/// Finalize array of srv/ServoCommandType messages.
/**
 * It calls
 * moveit_msgs__srv__ServoCommandType_Request__fini()
...
/// Create array of srv/ServoCommandType messages.
/**
 * It allocates the memory for the array and calls
 * moveit_msgs__srv__ServoCommandType_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ServoCommandType messages.
/**
 * It calls
 * moveit_msgs__srv__ServoCommandType_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ServoCommandType message array equality.
/**
...
/// Copy an array of srv/ServoCommandType messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__ServoCommandType_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__ServoCommandType_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It allocates the memory for the array and calls
 * moveit_msgs__srv__ServoCommandType_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__ServoCommandType_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOVEIT_MSGS__SRV__DETAIL__SERVO_COMMAND_TYPE__FUNCTIONS_H_
