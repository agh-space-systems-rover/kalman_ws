...
class Init_GetCartesianPath_Request_max_cartesian_speed
{
public:
  explicit Init_GetCartesianPath_Request_max_cartesian_speed(::moveit_msgs::srv::GetCartesianPath_Request & msg)
  : msg_(msg)
  {}
  ::moveit_msgs::srv::GetCartesianPath_Request max_cartesian_speed(::moveit_msgs::srv::GetCartesianPath_Request::_max_cartesian_speed_type arg)
  {
...
class Init_GetCartesianPath_Request_cartesian_speed_limited_link
{
public:
  explicit Init_GetCartesianPath_Request_cartesian_speed_limited_link(::moveit_msgs::srv::GetCartesianPath_Request & msg)
  : msg_(msg)
  {}
  Init_GetCartesianPath_Request_max_cartesian_speed cartesian_speed_limited_link(::moveit_msgs::srv::GetCartesianPath_Request::_cartesian_speed_limited_link_type arg)
  {
    msg_.cartesian_speed_limited_link = std::move(arg);
    return Init_GetCartesianPath_Request_max_cartesian_speed(msg_);
  }
...
class Init_GetCartesianPath_Request_max_acceleration_scaling_factor
{
public:
  explicit Init_GetCartesianPath_Request_max_acceleration_scaling_factor(::moveit_msgs::srv::GetCartesianPath_Request & msg)
  : msg_(msg)
  {}
  Init_GetCartesianPath_Request_cartesian_speed_limited_link max_acceleration_scaling_factor(::moveit_msgs::srv::GetCartesianPath_Request::_max_acceleration_scaling_factor_type arg)
  {
    msg_.max_acceleration_scaling_factor = std::move(arg);
    return Init_GetCartesianPath_Request_cartesian_speed_limited_link(msg_);
  }
...
class Init_GetCartesianPath_Request_max_velocity_scaling_factor
{
public:
  explicit Init_GetCartesianPath_Request_max_velocity_scaling_factor(::moveit_msgs::srv::GetCartesianPath_Request & msg)
  : msg_(msg)
  {}
  Init_GetCartesianPath_Request_max_acceleration_scaling_factor max_velocity_scaling_factor(::moveit_msgs::srv::GetCartesianPath_Request::_max_velocity_scaling_factor_type arg)
  {
    msg_.max_velocity_scaling_factor = std::move(arg);
    return Init_GetCartesianPath_Request_max_acceleration_scaling_factor(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_GetCartesianPath_Request_max_velocity_scaling_factor path_constraints(::moveit_msgs::srv::GetCartesianPath_Request::_path_constraints_type arg)
  {
    msg_.path_constraints = std::move(arg);
    return Init_GetCartesianPath_Request_max_velocity_scaling_factor(msg_);
  }
