...
moveit_msgs__msg__MotionPlanRequest__init(moveit_msgs__msg__MotionPlanRequest * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->cartesian_speed_limited_link)) {
    moveit_msgs__msg__MotionPlanRequest__fini(msg);
    return false;
  }
  // max_cartesian_speed
...
moveit_msgs__msg__MotionPlanRequest__fini(moveit_msgs__msg__MotionPlanRequest * msg)
{
  ...
  // max_acceleration_scaling_factor
  // cartesian_speed_limited_link
  rosidl_runtime_c__String__fini(&msg->cartesian_speed_limited_link);
  // max_cartesian_speed
}
...
moveit_msgs__msg__MotionPlanRequest__are_equal(const moveit_msgs__msg__MotionPlanRequest * lhs, const moveit_msgs__msg__MotionPlanRequest * rhs)
{
  ...
  // cartesian_speed_limited_link
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->cartesian_speed_limited_link), &(rhs->cartesian_speed_limited_link)))
  {
    return false;
  }
  // max_cartesian_speed
  ...
  moveit_msgs__msg__MotionPlanRequest * output)
{
  ...
  // cartesian_speed_limited_link
  if (!rosidl_runtime_c__String__copy(
      &(input->cartesian_speed_limited_link), &(output->cartesian_speed_limited_link)))
  {
    return false;
  }
  // max_cartesian_speed
