...
struct MotionPlanRequest_
{
  ...
  : workspace_parameters(_alloc, _init),
    ...
    planner_id(_alloc),
    group_name(_alloc),
    cartesian_speed_limited_link(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  using _cartesian_speed_limited_link_type =
    std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
  ...
  Type & set__cartesian_speed_limited_link(
    const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> & _arg)
  {
    this->cartesian_speed_limited_link = _arg;
    return *this;
  }
  ...
  bool operator==(const MotionPlanRequest_ & other) const
  {
    ...
    if (this->cartesian_speed_limited_link != other.cartesian_speed_limited_link) {
      return false;
    }
