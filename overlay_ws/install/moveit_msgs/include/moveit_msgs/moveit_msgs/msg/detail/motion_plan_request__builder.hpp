...
class Init_MotionPlanRequest_cartesian_speed_limited_link
{
public:
  explicit Init_MotionPlanRequest_cartesian_speed_limited_link(::moveit_msgs::msg::MotionPlanRequest & msg)
  : msg_(msg)
  {}
  Init_MotionPlanRequest_max_cartesian_speed cartesian_speed_limited_link(::moveit_msgs::msg::MotionPlanRequest::_cartesian_speed_limited_link_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_MotionPlanRequest_cartesian_speed_limited_link max_acceleration_scaling_factor(::moveit_msgs::msg::MotionPlanRequest::_max_acceleration_scaling_factor_type arg)
  {
    msg_.max_acceleration_scaling_factor = std::move(arg);
    return Init_MotionPlanRequest_cartesian_speed_limited_link(msg_);
  }
