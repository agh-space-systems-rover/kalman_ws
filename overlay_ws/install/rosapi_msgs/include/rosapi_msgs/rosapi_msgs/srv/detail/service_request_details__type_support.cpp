...
void fetch_function__ServiceRequestDetails_Response__typedefs(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rosapi_msgs::msg::TypeDef *>(
    get_const_function__ServiceRequestDetails_Response__typedefs(untyped_member, index));
  auto & value = *reinterpret_cast<rosapi_msgs::msg::TypeDef *>(untyped_value);
  value = item;
}

void assign_function__ServiceRequestDetails_Response__typedefs(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rosapi_msgs::msg::TypeDef *>(
    get_function__ServiceRequestDetails_Response__typedefs(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServiceRequestDetails_Response_message_member_array[1] = {
  {
    ...
    fetch_function__ServiceRequestDetails_Response__typedefs,  // fetch(index, &value) function pointer
    assign_function__ServiceRequestDetails_Response__typedefs,  // assign(index, value) function pointer
