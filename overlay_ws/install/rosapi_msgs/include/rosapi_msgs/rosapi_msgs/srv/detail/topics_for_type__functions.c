...
bool
rosapi_msgs__srv__TopicsForType_Request__are_equal(const rosapi_msgs__srv__TopicsForType_Request * lhs, const rosapi_msgs__srv__TopicsForType_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rosapi_msgs__srv__TopicsForType_Request__copy(
  const rosapi_msgs__srv__TopicsForType_Request * input,
  rosapi_msgs__srv__TopicsForType_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
rosapi_msgs__srv__TopicsForType_Request__create()
{
  ...
  rosapi_msgs__srv__TopicsForType_Request * msg = (rosapi_msgs__srv__TopicsForType_Request *)allocator.allocate(sizeof(rosapi_msgs__srv__TopicsForType_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__TopicsForType_Request__Sequence__init(rosapi_msgs__srv__TopicsForType_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__TopicsForType_Request *)allocator.zero_allocate(size, sizeof(rosapi_msgs__srv__TopicsForType_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__TopicsForType_Request__Sequence * array = (rosapi_msgs__srv__TopicsForType_Request__Sequence *)allocator.allocate(sizeof(rosapi_msgs__srv__TopicsForType_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rosapi_msgs__srv__TopicsForType_Request__Sequence__are_equal(const rosapi_msgs__srv__TopicsForType_Request__Sequence * lhs, const rosapi_msgs__srv__TopicsForType_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosapi_msgs__srv__TopicsForType_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosapi_msgs__srv__TopicsForType_Request__Sequence__copy(
  const rosapi_msgs__srv__TopicsForType_Request__Sequence * input,
  rosapi_msgs__srv__TopicsForType_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosapi_msgs__srv__TopicsForType_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosapi_msgs__srv__TopicsForType_Request * data =
      (rosapi_msgs__srv__TopicsForType_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosapi_msgs__srv__TopicsForType_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosapi_msgs__srv__TopicsForType_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosapi_msgs__srv__TopicsForType_Request__copy(
...
bool
rosapi_msgs__srv__TopicsForType_Response__are_equal(const rosapi_msgs__srv__TopicsForType_Response * lhs, const rosapi_msgs__srv__TopicsForType_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rosapi_msgs__srv__TopicsForType_Response__copy(
  const rosapi_msgs__srv__TopicsForType_Response * input,
  rosapi_msgs__srv__TopicsForType_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__TopicsForType_Response * msg = (rosapi_msgs__srv__TopicsForType_Response *)allocator.allocate(sizeof(rosapi_msgs__srv__TopicsForType_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__TopicsForType_Response__Sequence__init(rosapi_msgs__srv__TopicsForType_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__TopicsForType_Response *)allocator.zero_allocate(size, sizeof(rosapi_msgs__srv__TopicsForType_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__TopicsForType_Response__Sequence * array = (rosapi_msgs__srv__TopicsForType_Response__Sequence *)allocator.allocate(sizeof(rosapi_msgs__srv__TopicsForType_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rosapi_msgs__srv__TopicsForType_Response__Sequence__are_equal(const rosapi_msgs__srv__TopicsForType_Response__Sequence * lhs, const rosapi_msgs__srv__TopicsForType_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosapi_msgs__srv__TopicsForType_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosapi_msgs__srv__TopicsForType_Response__Sequence__copy(
  const rosapi_msgs__srv__TopicsForType_Response__Sequence * input,
  rosapi_msgs__srv__TopicsForType_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosapi_msgs__srv__TopicsForType_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosapi_msgs__srv__TopicsForType_Response * data =
      (rosapi_msgs__srv__TopicsForType_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosapi_msgs__srv__TopicsForType_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosapi_msgs__srv__TopicsForType_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosapi_msgs__srv__TopicsForType_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
