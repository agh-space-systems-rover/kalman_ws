...
{
  new (message_memory) rosapi_msgs::srv::SetParam_Request(_init);
}

void SetParam_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi_msgs::srv::SetParam_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetParam_Request_message_member_array[2] = {
  {
    ...
    offsetof(rosapi_msgs::srv::SetParam_Request, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi_msgs::srv::SetParam_Request, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetParam_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(rosapi_msgs::srv::SetParam_Request),
...
{
  return &::rosapi_msgs::srv::rosidl_typesupport_introspection_cpp::SetParam_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi_msgs, srv, SetParam_Request)() {
  return &::rosapi_msgs::srv::rosidl_typesupport_introspection_cpp::SetParam_Request_message_type_support_handle;
}
...
void SetParam_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rosapi_msgs::srv::SetParam_Response(_init);
}

void SetParam_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi_msgs::srv::SetParam_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetParam_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi_msgs::srv::SetParam_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetParam_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi_msgs::srv::SetParam_Response),
...
{
  return &::rosapi_msgs::srv::rosidl_typesupport_introspection_cpp::SetParam_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi_msgs, srv, SetParam_Response)() {
  return &::rosapi_msgs::srv::rosidl_typesupport_introspection_cpp::SetParam_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetParam_service_members = {
  ...
  // see get_service_type_support_handle<rosapi_msgs::srv::SetParam>()
...
get_service_type_support_handle<rosapi_msgs::srv::SetParam>()
{
  ...
  auto service_type_support =
    &::rosapi_msgs::srv::rosidl_typesupport_introspection_cpp::SetParam_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::rosapi_msgs::srv::SetParam_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::rosapi_msgs::srv::SetParam_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi_msgs, srv, SetParam)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rosapi_msgs::srv::SetParam>();
}
