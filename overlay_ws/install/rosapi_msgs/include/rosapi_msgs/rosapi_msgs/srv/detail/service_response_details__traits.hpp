...
inline void to_flow_style_yaml(
  const ServiceResponseDetails_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: type
...
inline std::string to_yaml(const ServiceResponseDetails_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rosapi_msgs::srv::ServiceResponseDetails_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosapi_msgs::srv::ServiceResponseDetails_Request & msg)
{
...
inline void to_flow_style_yaml(
  const ServiceResponseDetails_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: typedefs
...
inline std::string to_yaml(const ServiceResponseDetails_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rosapi_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosapi_msgs::srv::ServiceResponseDetails_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosapi_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosapi_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosapi_msgs::srv::ServiceResponseDetails_Response & msg)
{
  return rosapi_msgs::srv::to_yaml(msg);
}
