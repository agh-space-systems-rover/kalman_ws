...
#ifndef ROSAPI_MSGS__SRV__DETAIL__SERVICE_RESPONSE_DETAILS__STRUCT_HPP_
#define ROSAPI_MSGS__SRV__DETAIL__SERVICE_RESPONSE_DETAILS__STRUCT_HPP_
...
struct ServiceResponseDetails_Request_
{
  ...
  explicit ServiceResponseDetails_Request_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ServiceResponseDetails_Request_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : type(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
...
struct ServiceResponseDetails_Response_
{
  ...
  explicit ServiceResponseDetails_Response_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit ServiceResponseDetails_Response_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // ROSAPI_MSGS__SRV__DETAIL__SERVICE_RESPONSE_DETAILS__STRUCT_HPP_
