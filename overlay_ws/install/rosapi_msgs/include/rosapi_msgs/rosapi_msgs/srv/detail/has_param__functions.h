...
#ifndef ROSAPI_MSGS__SRV__DETAIL__HAS_PARAM__FUNCTIONS_H_
#define ROSAPI_MSGS__SRV__DETAIL__HAS_PARAM__FUNCTIONS_H_
...
/// Initialize srv/HasParam message.
/**
...
/// Create srv/HasParam message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosapi_msgs__srv__HasParam_Request__init().
...
/// Destroy srv/HasParam message.
/**
 * It calls
 * rosapi_msgs__srv__HasParam_Request__fini()
...
/// Check for srv/HasParam message equality.
/**
...
/// Initialize array of srv/HasParam messages.
/**
...
/// Finalize array of srv/HasParam messages.
/**
 * It calls
 * rosapi_msgs__srv__HasParam_Request__fini()
...
/// Create array of srv/HasParam messages.
/**
 * It allocates the memory for the array and calls
 * rosapi_msgs__srv__HasParam_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/HasParam messages.
/**
 * It calls
 * rosapi_msgs__srv__HasParam_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/HasParam message array equality.
/**
...
/// Copy an array of srv/HasParam messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosapi_msgs__srv__HasParam_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi_msgs
...
/**
 * It calls
 * rosapi_msgs__srv__HasParam_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi_msgs
...
/**
 * It allocates the memory for the array and calls
 * rosapi_msgs__srv__HasParam_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi_msgs
...
/**
 * It calls
 * rosapi_msgs__srv__HasParam_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSAPI_MSGS__SRV__DETAIL__HAS_PARAM__FUNCTIONS_H_
