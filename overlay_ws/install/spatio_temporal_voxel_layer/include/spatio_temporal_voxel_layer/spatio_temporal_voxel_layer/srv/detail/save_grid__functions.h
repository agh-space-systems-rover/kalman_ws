...
#ifndef SPATIO_TEMPORAL_VOXEL_LAYER__SRV__DETAIL__SAVE_GRID__FUNCTIONS_H_
#define SPATIO_TEMPORAL_VOXEL_LAYER__SRV__DETAIL__SAVE_GRID__FUNCTIONS_H_
...
#include "spatio_temporal_voxel_layer/msg/rosidl_generator_c__visibility_control.h"

#include "spatio_temporal_voxel_layer/srv/detail/save_grid__struct.h"

/// Initialize srv/SaveGrid message.
/**
...
/// Create srv/SaveGrid message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Request__init().
...
/// Destroy srv/SaveGrid message.
/**
 * It calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Request__fini()
...
/// Check for srv/SaveGrid message equality.
/**
...
/// Initialize array of srv/SaveGrid messages.
/**
...
/// Finalize array of srv/SaveGrid messages.
/**
 * It calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Request__fini()
...
/// Create array of srv/SaveGrid messages.
/**
 * It allocates the memory for the array and calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SaveGrid messages.
/**
 * It calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SaveGrid message array equality.
/**
...
/// Copy an array of srv/SaveGrid messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_spatio_temporal_voxel_layer
...
/**
 * It calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_spatio_temporal_voxel_layer
...
/**
 * It allocates the memory for the array and calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_spatio_temporal_voxel_layer
...
/**
 * It calls
 * spatio_temporal_voxel_layer__srv__SaveGrid_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SPATIO_TEMPORAL_VOXEL_LAYER__SRV__DETAIL__SAVE_GRID__FUNCTIONS_H_
